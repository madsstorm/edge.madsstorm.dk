export class LocalizedContent {
    async CreateResponse({event}) {
        ...
        body += `<a href="/"><div><img src="${countryDetails.flag}" alt="${countryDetails.name}" /></div></a><br><a title="mailto:john.doe@example.com" href="mailto:john.doe@example.com">john.doe@example.com</a>`;
